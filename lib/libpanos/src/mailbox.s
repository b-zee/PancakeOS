...
/* NEW
* panos_mailbox_read returns the current value in the mailbox addressed to a channel
* given in the low 4 bits of r0, as the top 28 bits of r0.
* C++ Signature: u32 panos_mailbox_read(u8 channel)
*/
.globl panos_mailbox_read
panos_mailbox_read: 
	and r3,r0,#0xf
	mov r2,lr
	bl GetMailboxBase
...
/* NEW
* panos_mailbox_write writes the value given in the top 28 bits of r0 to the channel
* given in the low 4 bits of r1.
* C++ Signature: void panos_mailbox_write(u32 value, u8 channel)
*/
.globl panos_mailbox_write
panos_mailbox_write: 
	and r2,r1,#0xf
